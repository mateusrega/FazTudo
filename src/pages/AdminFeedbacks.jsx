...
const AdminFeedbacks = () => {
  ...
  const feedbacksPorDia = feedbacksFiltrados.reduce((acc, f) => {
    const dia = f.createdAt?.toDate ? f.createdAt.toDate().toLocaleDateString('pt-BR') : "Sem data";
    if (!acc[dia]) acc[dia] = [];
    acc[dia].push(f);
    return acc;
  }, {});
  ...
  const isNovo = (createdAt) => {
    ...
    const dataFeedback = createdAt.toDate();
    return (agora - dataFeedback) < 24 * 60 * 60 * 1000; // últimos 24h
  };
      ...
      <div className="lg:ml-64 p-4 md:p-6">
        <div className="pt-16 lg:pt-0 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 border border-gray-200 mb-6">
            ...
            {/* ... Botões de filtro, mesmo código anterior ... */}
          </div>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <span className="text-xs text-gray-500">
                                {createdAt?.toDate ? createdAt.toDate().toLocaleString('pt-BR') : "Sem data"}
                              </span>
                              {isNovo(createdAt) && (
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-500">
                              ...
                              <span className="truncate">{userMap[userId] || userId}</span>
                            </div>
                          </div>
